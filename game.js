...
/* ============================= GLOBAL PLAY COUNTER =============================
   A simple cross-visitor "how many games have started" counter, stored in
   Firebase so it's not limited to one browser like the local stats above.
...
function renderLandingEmblem(){
  return `<img class="landing-emblem" src="assets/images/logo-full.png" alt="Zhaimer" />`;
}
