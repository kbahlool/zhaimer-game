...
function renderReveal(){
  ...
  <div class="reveal-wrap">
    <div class="reveal-scroll">
      <h2 style="margin:0 0 10px;font-size:17px;">${t('revealHeading', ROOM.round)}</h2>
      ${results.map(r=>{
      ...
      ${ROOM.roundWinnerName? `<p style="color:var(--teal);margin:8px 0 0;font-size:13px;">${t('roundWinnerMsg', ROOM.roundWinnerName)}</p>`:''}
      ...
      <div style="margin-top:12px;padding-top:10px;border-top:1px solid var(--line);">
        <div style="font-size:10px;letter-spacing:2px;text-transform:uppercase;color:var(--muted);margin-bottom:6px;">${t('runningTotals')}</div>
